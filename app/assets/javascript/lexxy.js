    ...
    return `
      ...
      <details class="lexxy-editor__toolbar-dropdown" name="lexxy-dropdown">
        ...
        <lexxy-comment-dropdown class="lexxy-editor__toolbar-dropdown-content">
          <form method="dialog">
            <textarea rows="10" placeholder="Kommentar…" class="input" required></textarea>
            <div class="lexxy-editor__toolbar-dropdown-actions">
              <button type="submit" value="insertMarkNodeOnSelection" class="btn">Speichern</button>
            </div>
          </form>
...
class ActionTextAttachmentMarkNode extends f {
    ...
    createDOM(config) {
        ...
        lt$4(element, config.theme.mark);
        this.setContentAttributes(element);
        if (this.__ids.length > 1) {
            lt$4(element, config.theme.markOverlap);
        }
        return element
    }
...
class CommentDropdown extends ToolbarDropdown {
